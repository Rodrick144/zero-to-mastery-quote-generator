const floodPageWithAnArray = document.getElementById('too-much');

let possibleWords1 = `aback
abase
abate
abbey
abbot
...
for (let i = 0; i <= (possibleWords1.length); i = i + 1) {
    if (charCounter1 == 5) {
        charCounter1 = -1;
        letterCache = `"` + letterCache + `"`;
        possibleWords2.push(letterCache);
        letterCache = "";
        console.log("add a word");
        console.log(charCounter1);
    } else {
        let tackOn = possibleWords1[i];
